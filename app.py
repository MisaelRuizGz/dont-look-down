...
# ============================================================
# PYDANTIC MODELS (what the API expects to receive)
# ============================================================
...
@app.post("/save-score")
def save_score(score: dict, current_user = Depends(get_current_user), conn = Depends(get_db)):
    cur = conn.cursor()
    cur.execute(
